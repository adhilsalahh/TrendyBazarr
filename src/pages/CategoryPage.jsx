...
import { Filter, SortAsc, ChevronLeft, ChevronRight, Star, Heart, ShoppingCart, X } from 'lucide-react';
...
function PaginationControls({ currentPage, totalPages, setCurrentPage, className = '' }) {
  ...
  const renderPageButton = (pageNum, active) => (
    <button
