...
//                     >
//                       <img
//                         src={productDetails[selectedProduct.id]?.images[selectedImage] || selectedProduct.images[0]}
...
//                     {productDetails[selectedProduct.id]?.images.map((image, index) => (
//                       <button
//                         key={index}
...
//                         style={{
//                           backgroundImage: `url(${productDetails[selectedProduct.id]?.images[selectedImage] || selectedProduct.images[0]})`,
...
//                   {/* Specifications */}
//                   {productDetails[selectedProduct.id]?.specs && (
//                     <div className="border-t pt-6">
//                       <h3 className="text-lg font-semibold mb-4">Specifications</h3>
//                       <div className="grid grid-cols-2 gap-4">
//                         {Object.entries(productDetails[selectedProduct.id].specs).map(([key, value]) => (
...
import React, { useState } from 'react';
import { Link } from 'react-router-dom';
import { ShoppingCart, Heart } from 'lucide-react'; // Removed ChevronRight import
import { products } from './ProductPage';
